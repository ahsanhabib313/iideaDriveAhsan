...
const secondaryDisplay = document.getElementById("secondary-display"); -->
  ...
  <div class="calc-btn" id="btn">
    ...
    {{-- <button class="calc-btn-primary " id="divide">/</button> --}}
...
const secondaryDisplay = document.getElementById("secondary-display"); -->
    ...
    {{-- <button class="calc-btn-primary" id="multiply">*</button> --}}
    ...
    {{-- <button class="calc-btn-primary " id="add">+</button> --}}
    {{-- <button class="calc-btn-primary" id="decimal">.</button> --}}
    <button class="calc-btn-primary" id="zero">0</button>
        <!-- const btns = document.getElementById("btn");
const primaryDisplay = document.getElementById("display");
const secondaryDisplay = document.getElementById("secondary-display"); -->
    {{-- <button class="calc-btn-primary" id="equals">=</button>
    <button class="calc-btn-primary " id="subtract">-</button> --}}
